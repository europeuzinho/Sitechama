...
export default function RestaurantPage() {
  ...
  useEffect(() => {
    ...
    const handleDataChange = () => {
        // This function will be called when `restaurantsChanged` or `reviewsChanged` is dispatched
        // It re-fetches the restaurant data, which now includes the logic to check session storage for images.
        loadRestaurant();
    };
